...
public class CodePainter_v1 extends PApplet {
    ...
    private void initializePGUIObjects() {
        ...
        PGuiObjects = new ArrayList<PGuiObject>();
        PGuiObjects.add(colorSelector);
        PGuiObjects.add(newImageBtm);
        PGuiObjects.add(newEllipseBtm);
        PGuiObjects.add(newLineBtm);
        PGuiObjects.add(newRectBtm);
        PGuiObjects.add(newTextBtn);
        PGuiObjects.add(console);
        PGuiObjects.add(zoom);
        PGuiObjects.add(drawBoard);
        for (SingleLineTextBox objectPropertiesBox : objectPropertiesBoxes) {
            PGuiObjects.add(objectPropertiesBox);
        }
    ...
    private void setFocusTo(PGuiObject component) {
        focusChanged = component != null || !component.equals(focusedPPComponent);
        if (!focusChanged) {
            return;
        }
